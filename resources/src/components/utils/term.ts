export const term = {
    ...
    second: {
        heading: "第2条 利用登録",
        lists: [
            " 本サービスにおいては，登録希望者が本規約に同意の上，提供者の定める方法によって利用登録を申請し，提供者がこれを承認することによって，利用登録が完了するものとします。",
    ...
    forth: {
        ...
        lists: [
            "ユーザーは，本サービスの有料部分の対価として，提供者が別途定め，本ウェブサイトに表示する利用料金を，提供者が指定する方法により支払うものとします。",
